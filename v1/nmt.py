...
# batch preparation
def prepare_data(options, seqs_x, seqs_y, maxlen=None, n_words_src=30000,
                 n_words=30000):
    ...
    x = numpy.zeros((maxlen_x, n_samples, options['dim_feature'])).astype('float32')
...
def train(dim_word=100,  # word vector dimensionality
    ...
    for eidx in xrange(max_epochs):
        ...
        for x, y in train:
            ...
            x, x_mask, y, y_mask = prepare_data(model_options, x, y, maxlen=maxlen)
